Sbflander::Application.routes.draw do
  ...
  get "dalep/v1/i4" => "pages#dalep-v1-i4"
  get "colinf/v1/i4" => "pages#colinf-v1-i4"
  get "jasonl/v1/i4" => "pages#jasonl-v1-i4"  
  get "tonya/v1/i4" => "pages#tonya-v1-i4"
  get "jodie/v1/i4" => "pages#jodie-v1-i4"
  get "timw/v1/i4" => "pages#timw-v1-i4"
  get "nickb/v1/i4" => "pages#nickb-v1-i4"
  get "terryc/v1/i4" => "pages#terryc-v1-i4"
  get "carolo/v1/i4" => "pages#carolo-v1-i4"
  get "djw/v1/i4" => "pages#djw-v1-i4"
